...
Here we enroll the same node as both producer and consumer. In practice, producers and consumers are often separate nodes -- see [Understanding the .aster-identity file](/docs/concepts/identity-file) *(coming soon)*.

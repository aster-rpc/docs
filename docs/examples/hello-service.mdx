...
- `AsterClient(address=...)` takes the `aster1...` address printed by the producer. Alternatively, set `ASTER_ENDPOINT_ADDR` as an environment variable and omit the argument.

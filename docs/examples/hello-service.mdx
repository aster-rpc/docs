...
- Add `@wire_type` tags for production stability: [Define a Service](/guides/define-a-service)
- Connect with credentials: [Dial a Service](/guides/dial-a-service)
- Add streaming methods: [Define a Service -- Streaming](/guides/define-a-service#server-streaming-server_stream)
